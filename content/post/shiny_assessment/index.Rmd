...
The app contains four tabs: Data, About, Change in Visitors by Category and COVID-19 Cases/Deaths. Following are the discussion of the contents of these four tabs.
...
The “Data” tab in the dashboard provides an overview of raw data used in this app. And the data source and source of the code are provided under the “About” if the users want to reproduce the shiny app, it can provide the users with a preliminary understanding of the data and easier to obtain the code.

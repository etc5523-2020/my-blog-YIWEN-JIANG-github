...
covid %>%
  filter(location == "Belarus") %>%
  miss_var_summary() %>%
  rename(c("Variable" = "variable",
           "Number of Missing Values" = "n_miss",
           "Percentage of Missing Values" = "pct_miss")) %>%
  kable(caption = "Missing values in COVID-19 data") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))


# variable_na$pct_miss <- color_tile("white", "orange")(variable_na$pct_miss)
```
